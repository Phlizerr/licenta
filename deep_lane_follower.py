...
class EndToEndLaneFollower(object):
    ...
    def __init__(self,
                 car=None,
                 model_path='lane_navigation.h5'):
        logging.info('Creating a EndToEndLaneFollower...')

        self.car = car
        self.curr_steering_angle = 90
        self.model = load_model('lane_navigation.h5')
    ...
    def compute_steering_angle(self, frame):
        ...
        return int(steering_angle) # round the nearest integer
...
if __name__ == '__main__':
    ...
    test_video('reality.mp4')
    #test_photo('reality.jpg')
