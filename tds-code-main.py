...
from deep_lane_follower import EndToEndLaneFollower
...
class DeepPiCar(object):
    ...
    def __init__(self):
        ...
        #self.lane_follower = DeepLearningLaneFollower()
    ...
    def manual_speed_test(self):
        """ Test the car speed manually """
        logging.info('Testing forward speed...')
        self.back_wheels.forward()
        self.back_wheels.speed = 30  # Set a moderate positive speed
        time.sleep(5)
        logging.info('Testing stop...')
        self.back_wheels.speed = 0
        time.sleep(2)
        logging.info('Testing backward speed...')
        self.back_wheels.backward()
        self.back_wheels.speed = 30  # Set a moderate negative speed
        time.sleep(5)
